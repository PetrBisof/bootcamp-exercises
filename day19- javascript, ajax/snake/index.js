...
render(){
  ...
  this.element.innerHTML = (
    ` <svg id ="snake" class="snail" viewBox="0 0 260 200" xmlns="http://www.w3.org/2000/svg">
...
changeColor = () => {
  const colorSnail = this.element.querySelector('.snail__shell');
  
  colorSnail.style.fill = this.color;
  
  console.log('the function is running ', colorSnail.style.fill)
  return colorSnail.style.fill
  }
...
if (timerID === 5){
timerID = setInterval ( () =>{
const moveSnake = this.element.querySelector('#snake');
moveSnake.style.left = `${counter*2}px`;
counter++;}, this.velocity)
 }
 else if(timerID != 5) {
...
/* counter = 1;
const moveSnake = document.querySelector('.snail__body');
moveSnake.addEventListener('click', () => {
moveSnake.style.fill = "black";
})
 */
...
if (timerID === 5){
timerID = setInterval ( () =>{
const moveSnake = document.querySelector('#snake');
moveSnake.style.left = `${counter*2}px`;
counter++;}, 40)
 }
 else if(timerID != 5) {
...
/* const moveSnake = document.querySelector('#snake');
moveSnake.addEventListener('click', () => {
moveSnake.style.left = `${counter*50}px`;
counter++
console.log(moveSnake.style.left) */